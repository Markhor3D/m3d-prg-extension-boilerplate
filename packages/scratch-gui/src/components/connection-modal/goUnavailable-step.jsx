...
import goIcon from './icons/m3d-go-small.png';
            ...
            <div className={styles.scratchLinkHelp}>
                <div className={styles.scratchLinkHelpStep}>
                    ...
                    <div className={styles.helpStepText}>
                        <FormattedMessage
                            defaultMessage="Make sure you have turned on M3D Go"
                            description="Message for getting M3D Go turned on"
                            id="gui.connection.unavailable.turnOnGo"
                        />
                    </div>
                </div>
                <div className={styles.scratchLinkHelpStep}>
